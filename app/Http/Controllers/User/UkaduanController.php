...
class UkaduanController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('user.ukaduan')->with('title', $title)->with('jk', $jk)->with('opds', $opds)->with('datakaduan', $datakaduan)->with('user', $user);
    }
