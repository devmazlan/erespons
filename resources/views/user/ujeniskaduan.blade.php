                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <div class="col">
                                        <form action="{{ route('ujeniskaduan.destroy', $p->id) }}" method="POST">
...
<div class="modal fade " id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <form action="{{ route('ujeniskaduan.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" value="{{ $user->opd }}" name="opd" id="">
                </div>
